...
import { InkBrush, InkEraserMode, InkImageAnnotation, InkLinePattern, InkPoint, InkSelectionMode, InkStroke, InkTextAnnotation, InkTool, SelectionRect } from '../../../ui-types';
  ...
  if (props.subject) {
    ...
    return (
      <ScrollView style={props.styles.main} contentContainerStyle={props.styles.mobilePage}>
        ...
        <PhotoViewerModal
          asset={previewAsset}
          references={props.allPageCaptureReferences}
