...
export function PdfPreview(props: {
  ...
  const flatListExtraData = useMemo(() => ({
    ...
    viewerWidth,
    visiblePageKeys,
  }), [capturingSelection, currentStroke, draftSelection, draftSelectionPageKey, draftSelectionPath, props.activeGeneratedPageId, props.page, props.selectionMode, props.selectionRect, pdfSourceKey, viewerHeight, viewerWidth, visiblePageKeys]);
  ...
  }, [baseViewerWidth, getPdfRenderCacheKey, pdfPagesToRender, props.file, props.onDocumentLoaded, renderedPdfPages]);
