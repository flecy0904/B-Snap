            ...
            <View style={[S.main, isWeb && !notebookFullscreen && S.webMainShell, notebookFullscreen && S.notebookFullscreenMain]}>
              ...
              {tab === 'notes' && (
                <DesktopNotes
                  ...
                  onOpenAppChatSidebar={notesState.openAppChatSidebar}
                  onOpenAppAiCanvasSidebar={notesState.openAppAiCanvasSidebar}
                  onCloseAppRightSidebar={notesState.closeAppRightSidebar}
