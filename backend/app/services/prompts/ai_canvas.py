...
4. Canvas block context, when provided for a block AI request.
...
8. Recent conversation, only to understand intent, style, or preferred format.
9. Note title and summary.
