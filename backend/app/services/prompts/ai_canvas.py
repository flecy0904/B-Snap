...
6. The compressed session summary and memory facts, only for older conversation continuity, stable user preferences, course scope, repeated concepts, decisions, and ongoing task state.
...
Use the compressed session summary, memory facts, and recent conversation only for continuity. Do not treat them as note, PDF, or Canvas source content.
