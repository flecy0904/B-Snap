...
4. The compressed session summary and memory facts, only for older conversation continuity, stable user preferences, course scope, repeated concepts, decisions, and ongoing task state.
...
Use the compressed session summary, memory facts, and recent conversation only to preserve continuity. Do not confuse them with note or PDF source content.
